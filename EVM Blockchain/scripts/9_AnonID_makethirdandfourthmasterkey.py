...
class LamportTest:
    ...
    def __init__(self):
        ...
        self.k3 = KeyTracker("Caloracle1")
        self.k4 = KeyTracker("Calmaster3")
        self.k5 = KeyTracker("Calmaster4")
        
        print("Initializing LamportBase2...")
        with open('CalFund-LamportBase2.txt', 'r') as file:
    ...
    def can_test_key_functions(self, accs):
        ...
        current_keys = self.k1.load(self, "Calmaster1", master_pkh_1)
        ...
        current_keys = self.k2.load(self, "Calmaster2", master_pkh_2)
        ...
        mastertestkeys = self.k5.get_next_key_pair()
        mtk_pkh = self.k5.pkh_from_public_key(mastertestkeys.pub)
        packed_message = mtk_pkh[2:] + nextpkh[2:]
        callhash = hash_b(packed_message)
        sig = sign_hash(callhash, current_keys.pri) 
