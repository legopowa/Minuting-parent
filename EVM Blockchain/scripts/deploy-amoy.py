...
def main():
    ...
    tx = wmatic.deposit({'from': deployer_account, 'value': web3.to_wei(2, 'ether')})
    tx.wait(1)
    ...
    calfund_token.approve(uniswap_router_address, cal_amount, {'from': deployer_account, 'gas_price': gas_price, 'gas_limit': gas_limit})

    # Approve the router to spend WMATIC
    wmatic.approve(uniswap_router_address, wmatic_amount, {'from': deployer_account, 'gas_price': gas_price, 'gas_limit': gas_limit})
    ...
    calfund_token.setUniswapPair(pair_address, {'from': deployer_account, 'gas_price': gas_price, 'gas_limit': gas_limit})
