...
class LamportTest:
    ...
    def __init__(self):
        ...
        with open('CalFund-AnonID.txt', 'r') as file:
        ...
        self.load_keys(opkhs, "Caloracle")
        print('init done')
    ...
    def can_test_key_functions(self, accs):
        ...
        current_keys = self.k4.load(self, "Calmaster3", master_pkh_3)
        ...
        with open('CalFund-Whitelist.txt', 'r') as file:
        ...
        current_keys = self.k5.load(self, "Calmaster4", master_pkh_4)
