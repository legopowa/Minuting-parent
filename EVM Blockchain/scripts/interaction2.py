...
def main():
    ...
    print('Deployer CAL balance:', web3.from_wei(ACoin_balance, 'ether'))
    ...
    ACoin.approve(router.address, amount_in_cal, {'from': deployer, 'gas_price': gas_price, 'gas_limit': gas_limit}).wait(1)
    swap_path_cal_to_weth = [ACoin.address, weth.address]
    ...
    new_cal_balance = ACoin.balanceOf(deployer.address)
