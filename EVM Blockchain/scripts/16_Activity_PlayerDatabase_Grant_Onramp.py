...
from brownie import network, web3, accounts, Wei, PlayerDatabase, LamportBase2, Contract
...
class LamportTest:
    ...
    def __init__(self):
        ...
        self.k4 = KeyTracker("Activitymaster3")
        self.k5 = KeyTracker("Activitymaster4")
        ...
        self.load_keys(opkhs, "Activityoracle")
        print('init done')
    ...
    def can_test_key_functions(self, accs):
        ...
        current_keys = self.k4.load(self, "Activitymaster3", master_pkh_3)
        ...
        with open('Activity-PlayerOnboardContract.txt', 'r') as file:
        ...
        _contract.updateOnrampContractAddressStepOne(
            current_keys.pub,
            sig,
            nextpkh,
            paddressToBroadcast,
        ...
        current_keys = self.k5.load(self, "Activitymaster4", master_pkh_4)
        ...
        _contract.updateOnrampContractAddressStepTwo(
            current_keys.pub,
            sig,
            nextpkh,
            paddressToBroadcast,
